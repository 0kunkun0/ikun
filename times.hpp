...
namespace times
{
    ...
    using sysapi::get_localtime_from_sysapi;
    ...
    string get_time() // 获取当前时间字符串
    {
        ...
        tm tm_info = get_localtime_from_sysapi(now_time); // sysapi.hpp
        
        const char* weekdays[] = {"日", "一", "二", "三", "四", "五", "六"};
        
        ostringstream oss;
        print(oss, "{:04d}年{:02d}月{:02d}日 星期{} {:02d}:{:02d}:{:02d}",
    ...
    {
        tm tm_info = get_localtime_from_sysapi(timestamp); // sysapi.hpp
